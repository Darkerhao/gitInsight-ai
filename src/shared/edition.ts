...
export const APP_EDITION_LABEL =
  typeof __APP_EDITION_LABEL__ === 'string' ? __APP_EDITION_LABEL__ : APP_EDITION === 'standard' ? '标准版' : '轻量版';
export const APP_PRODUCT_NAME =
  typeof __APP_PRODUCT_NAME__ === 'string' ? __APP_PRODUCT_NAME__ : `码迹 AI ${APP_EDITION_LABEL}`;
