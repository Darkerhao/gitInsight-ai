...
export const navKeys = ['config', 'generate', 'weekly', 'summary', 'reflection', 'history', 'timeline', 'ai', 'system'] as const;
...
const routes: RouteRecordRaw[] = [
  ...
  {
    path: '/:nav(config|generate|weekly|summary|reflection|history|timeline|ai|system)',
