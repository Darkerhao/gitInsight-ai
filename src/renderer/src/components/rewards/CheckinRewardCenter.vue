      ...
      <div class="effect-shop">
        <template v-for="group in effectTierGroups" :key="group.meta.key">
          ...
          <button
            ...
            :aria-label="`${effect.label}，${effect.cost} 甲币，${effect.codename}`"
          ...
          >
            ...
            <span class="effect-shop-copy">
              <strong class="effect-shop-name">
                {{ effect.label }}
                <em v-if="effect.apex">APEX</em>
              </strong>
              <span class="effect-shop-meta">
                <small class="effect-shop-codename">{{ effect.codename }}</small>
                <small class="effect-shop-price">{{ effect.cost }} 甲币</small>
              </span>
            </span>
          </button>
        </template>
...
.effect-shop-item.tier-singularity .effect-shop-name {
  color: #f1f5f9;
  text-shadow: 0 1px 10px rgba(15, 23, 42, 0.7);
}

.effect-shop-item.tier-singularity .effect-shop-codename {
  color: rgba(226, 232, 240, 0.62);
}

.effect-shop-item.tier-singularity .effect-shop-price {
